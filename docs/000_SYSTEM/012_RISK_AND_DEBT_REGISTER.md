...
| 1.9 | 2026-07-03 | D-004 pasado a 🟡 En progreso: consolidados los ADR embebidos de #02 en archivos individuales `ADR-001`..`ADR-009` + índice `adr/README.md`; esquema canónico de 3 dígitos codificado en 003 §7 (descartada la migración a 4 dígitos; ADR-010/011/012 conservan su nombre). Pendiente migrar embebidos de #04 (`ADR-A1`) y #06 (`ADR-I1..I4`). |
